...
# chmod +x setup.sh
#
# set the number of servers (1 or 3) expected by Consul in the cluster by providing IP addresses 
# as CLI arguments for example:
#
# ./setup.sh <ip address 1> <ip address 2> <ip address 3>
#
